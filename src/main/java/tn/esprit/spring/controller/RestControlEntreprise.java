...
import tn.esprit.spring.entities.DepartmentRequest;
import tn.esprit.spring.entities.Entreprise;
import tn.esprit.spring.entities.EntrepriseRequest;
...
public class RestControlEntreprise {
	...
	@ResponseBody
	public int ajouterEntreprise(@RequestBody EntrepriseRequest ssiiConsulting) {
		 Entreprise mission = new Entreprise(ssiiConsulting);
		ientrepriseservice.ajouterEntreprise(mission);
	...
	@ResponseBody
	public int ajouterDepartement(@RequestBody DepartmentRequest dep) {
		Departement department = new Departement(dep);
		return ientrepriseservice.ajouterDepartement(department);
	}
